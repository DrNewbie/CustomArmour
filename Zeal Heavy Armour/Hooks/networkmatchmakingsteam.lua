local ZealHeavyArmour_set_attributes_original = NetworkMatchMakingSTEAM.set_attributes
function NetworkMatchMakingSTEAM:set_attributes(settings, ...)
	...
	ZealHeavyArmour_set_attributes_original(self, settings, ...)
end

local ZealHeavyArmour_is_server_ok_original = NetworkMatchMakingSTEAM.is_server_ok
